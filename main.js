(function () {
    ...
    const menuLink5 = document.querySelector('.header_link5');
    const menuLink6 = document.querySelector('.header_link6');
    const menuLink7 = document.querySelector('.header_link7');
    ...
    menuLink7.addEventListener('click', () => {
        menu.classList.remove('header_nav_active');
    });
}());